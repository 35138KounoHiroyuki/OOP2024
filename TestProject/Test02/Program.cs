...
namespace Test02 {
    ...
    class Program {
        ...
        private static void Exercise03(List<int> numbers) {
            foreach (var sorteNumbers in numbers.Where(n => n % 2 == 0)
                                       .OrderByDescending(n => n)) {

                Console.WriteLine(sorteNumbers);
        ...
        private static void Exercise05(List<Person> persons) {
            ...
            var average = persons.Average(a => a.Age);
        ...
        private static void Exercise06(List<Person> persons) {
            var weight = persons.Where(h => h.Height >= 170)
                               .Average(w => w.Weight);
        ...
        private static void Exercise07(List<Person> persons) {
            foreach (var weight in persons.Where(w => w.Weight <= 70)) {
                Console.WriteLine(weight.Name + weight.Weight+"kg");
        ...
        private static void Exercise08(List<Person> persons) {
            foreach (var name in persons.Where(n => n.Name.Contains("山"))){
